            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div([
                        ...
                        dcc.Graph(figure=GetManagerTransactionFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),

                    html.Div([
                        html.H2("Empty Cylinder Sales Income"),
                        dcc.Graph(figure=EmptySellingIncomeFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),

                    html.Div([
                        html.H2("Vehicle Transactions"),
                        dcc.Graph(figure=VehicleTransactionFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),

                    html.Div([
                        html.H2("Unfinished Loan Balance"),
                        dcc.Graph(figure=UnFinishedLoanBalanceFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),

                    html.Div([
                        html.H2("Cylinder Sell Count"),
                        dcc.Graph(figure=CylinderSellCountFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),

                    html.Div([
                        html.H2("Customer Registration Stats"),
                        dcc.Graph(figure=RegAndUnregCustomerCountsFigure(
                            repository=repo)),
                    ], style={'backgroundColor': 'white', 'padding': '15px', 'borderRadius': '8px'}),
